...
\centering
\includegraphics[width=60mm, height=50mm]{leaffeatures/Figures/alledge.png}
		\caption{\label{alledge} Edge types of leaves focus in the study.}
\centering
		\includegraphics[width=60mm, height=50mm]{leaffeatures/Figures/imgshape.png}
		\caption{\label{shapeimg}Shape illustrations}		
		
\end{subfigure}	
\begin{subfigure}{.5\textwidth}
\centering
		\includegraphics[width=40mm, height=30mm]{leaffeatures/Figures/simple_leaf_parts.png}
		\caption{\label{simplearra} A leaf with simple arrangement.}
		
\end{subfigure}	

\caption{Illustration of edge type, shape illustration and components of a leaf}
	    \end{figure}
...
\caption{(a) Remove stalk and (b) closing holes}
	    \end{figure}
...
\caption{Features related to area}
	    \end{figure}
...
\caption{Features related to convexity}
	    \end{figure}
...
\caption{Preprocessing steps to compute scagnostics}
	    \end{figure}
...
\caption{Illustration of vertices, edge and convex hull}
	    \end{figure}
...
\caption{Illustration of image processing steps of Flavia dataset}
	    \end{figure}
