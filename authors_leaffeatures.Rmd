...
```{r pcaswedish, comment=NA, message=FALSE, warning=FALSE, echo= FALSE, fig.height=7, fig.width=7, fig.cap="\\label{pcaswedish}Distribution of Swedish leaf images on the projection space created based on pincipal component analysis. All projected points are coloured according to their shape labels.", fig.pos="H"}
library(tidyverse)
...
```{r pcaflavia, comment=NA, message=FALSE, warning=FALSE, echo= FALSE, fig.height=7, fig.width=7, fig.cap="\\label{pcaflavia}Distribution of Flavia leaf images on the projection space created based on pincipal component analysis. All projected points are coloured according to their shape labels."}
data_new1 <- read.csv("data/Flavia_dataset/data_all_with_label_flavia.csv", header = TRUE)
features1 <- data_new1[, c(3:10,12:53)] # remove Outlying_polar and Outlying_contour
