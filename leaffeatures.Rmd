...
```{r, comment=NA, message=FALSE, warning=FALSE, echo= FALSE, fig.height=10, fig.width=10, fig.cap="\\label{pcaswedish}Vertices of degree 2"}
...
p1h1 + p2h1 + p3h1 + p4h1 + p5h1 + p6h1 + p7h1 + p8h1 + p9h1 + plot_annotation(
  tag_levels = 'A'
) + plot_layout(guides = 'collect') & theme(plot.tag = element_text(size = 3))  & theme(legend.position = 'bottom')
