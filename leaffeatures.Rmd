...
knitr::include_graphics(here::here("Figures","c1.png"))
```
...
knitr::include_graphics(here::here("Figures","c2.png"))
```
...
knitr::include_graphics(here::here("Figures","sca.png"))
```	
...
```{r, echo=FALSE, out.width="90%", fig.align='center',fig.cap="\\label{flvhie}Hierarchy of Flavia leaf image dataset"}
knitr::include_graphics(here::here("Figures","hie.png"))
```  
...
\hline
\multicolumn{1}{c}{Species} & Label & SVM  & PNN-PCNN & Fourier Moment & PFT+ & Proposed Method \\ \hline
...
Tangerine                   & 32    & 1.00 & 0.90     & 0.80           & 0.90 & 1.00            \\ \hline
\multicolumn{2}{c}{Average}         & 0.82 & 0.91     & 0.46           & 0.93 & 0.98            \\ \hline
\end{tabular}%
}
\caption{Comparison accuracy of several methods using Flavia dataset}
\label{flvacc}
\end{table}
