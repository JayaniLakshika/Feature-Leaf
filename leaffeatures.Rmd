...
|       We use two publicly available datasets to demonstrate the applications of features. They are: i) Flavia leaf image dataset and iii) Swedish leaf image dataset
...
```{r ldaflavia, comment=NA, message=FALSE, warning=FALSE, echo= FALSE, fig.cap="\\label{ldaflavia}Distribution of Flavia leaf images on the projection space created based on linear discriminant analysis. All projected points are coloured according to their shape labels.", fig.width=15, fig.height=5}
