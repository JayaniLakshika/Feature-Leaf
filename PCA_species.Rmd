...
p191 <- ggplot(data_new1, aes(x=PC3, y=PC5, col=Species)) + geom_point(alpha = 0.5) +coord_equal()+ scale_colour_manual(values = c("#a6611a","#d7191c","#e66101","#1b9e77","#3182bd","#d95f02","#7570b3","#fc8d92","#31a354","#7b3294","#d01c8b","#8da0cb","#b2df8a","#3f007d","#67000d","#525252","#006d2c","#3690c0","#88419d","#8c96c6","#238B45","#fed976","#fc4e2a","#fe9929","#dd3497","#3690c0","#e7298a","#7f0000","#bcbddc","#66c2a4","#045a8d","#253494")) + ggtitle("PCA3 Vs PCA5 by Actual Species") + xlab("PCA3") + ylab("PCA5") + theme(aspect.ratio = 1) 
